const page = async () => {
  return (
    <>
      <div className="p-8 container m-8 rounded-lg">
        <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">
          قوانین و مقررات قهوه ست
        </h1>
        <div className="space-y-6">
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            سفارش وارد کنند و قهوه ست تنها برای ارسال همان سفارش، از این اطلاعات
            استفاده خواهد کرد. همچنین قهوه ست ممکن است برای ارتباط با مشتریان،
            بهینه سازی محتوای وب سایت و تحقیقات بازاریابی از برخی اطلاعات
            استفاده کند و برای اطلاع رسانی رویدادها و اخبار، خدمات و سرویس‌های
            ویژه یا پروموشن‌ها، برای اعضای وب سایت ایمیل یا پیامک ارسال نماید.
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            اختیار مراجع ذی‌صلاح قرار دهد.
          </p>
          <p className="text-gray-700 leading-relaxed">
            قهوه ست همانند سایر وب سایت‌ها از جمع آوری IP و کوکی‌ها استفاده
            می‌کند، اما پروتکل، سرور و لایه‌های امنیتی قهوه ست و روش‌های مناسب
            مدیریت داده‌ها اطلاعات کاربران را محافظت و از دسترسی‌های غیر قانونی
            جلوگیری می‌کند. قهوه ست برای حفاظت و نگهداری اطلاعات و حریم شخصی
            کاربران همه توان خود را به کار می‌گیرد و امیدوار است که تجربه‌ی
            خریدی امن، راحت و خوشایند را برای همه کاربران فراهم آورد. 66726563 –
            ۰۲۱09366726563 <strong>(پاسخگویی طی ساعات کاری)</strong>
          </p>
          <p className="text-gray-700 leading-relaxed">
            استان تهران – شهر تهران – خیابان انقلاب روبروی خیابان ویلا (نجات
            الهی) فروشگاه قهوه ست
          </p>
          <p className="text-gray-700 leading-relaxed">
